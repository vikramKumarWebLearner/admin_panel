...
class PermissionDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable->addColumn('name', function ($permissions) {
             return '<a href="' . route('permissions.show', $permissions->id) .'">'.$permissions->name.'</a>';
        });        
        $dataTable->addColumn('action', 'permissions.datatables_actions');
    ...
    {
        return ['create', 'export', 'print', 'reset', 'loadPermission'];
    }
    /**
     * Get columns.
     *
